  ...
  <footer class="site-footer">
    <div class="site-footer__inner">
      ...
      <div class="site-footer__creator">
        <strong>Entwickelt von Aleksandre (Sandro) Abashishvili</strong>
        <span>Software · Daten · Automatisierung</span>
        <div>
          <a href="https://sandro-abashishvili.sandroabashishvili.chatgpt.site/" target="_blank" rel="noopener noreferrer">Portfolio</a>

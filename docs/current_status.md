...
- `/jobs/` გვერდი ავტომატურად იღებს მიმდინარე ვაკანსიებს `Stadt Kassel`, `Hessen Mobil`, `Stadt Frankfurt`, `Stadt Wiesbaden` და `Stadt Darmstadt` წყაროებიდან
- Jobs გვერდს აქვს ტექსტური ძებნა, ქალაქისა და პროფესიული მიმართულების ფილტრები
- ვაკანსიები იყენებს Jobs-ისთვის ცალკე შექმნილ ადგილობრივ თემატურ ბანერებს
- შედეგები იყოფა 8-ვაკანსიან გვერდებად; ფილტრები მუშაობს სრულ მონაცემთა ნაკრებზე
- მძიმე nested-box განლაგება შეიცვალა ერთი მკაფიო ვაკანსიის ბარათით

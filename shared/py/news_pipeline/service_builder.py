...
def service_teaser_links(prefix: str = "./") -> str:
    links = (
        ...
        ("Bund", "Portal", "Leistungen und Behörden", f"{prefix}service/#behoerden-verwaltung"),
        ("Hessen.de", "Land", "Landesportal und Services", f"{prefix}service/#behoerden-verwaltung"),
        ("Städte", "Portale", "Kassel, Frankfurt und mehr", f"{prefix}service/#behoerden-verwaltung"),
        ...
        ("BKA", "Prävention", "Lagebilder und Warnhinweise", f"{prefix}service/#polizei-sicherheit"),
        ...
        ("Mobilität", "Hessen", "ÖPNV, Straße und Wege", f"{prefix}service/#verkehr-mobilitaet"),
